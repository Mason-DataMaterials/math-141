...
[](https://docs.google.com/spreadsheets/d/1rU4Q0JKf1ufdmnR0DIQf16IjkSmQyI_Ek73SknkopYI/edit#gid=411307732)

I've gone through and aggregated all of your data in the sheet called "Aggregate". This sheet was saved as a `.csv` file and can be read into R using:

```{r}
theses <- read.csv("https://www.dropbox.com/s/t0ovuuafxm0fye5/sample-theses.csv?dl=1")
```
